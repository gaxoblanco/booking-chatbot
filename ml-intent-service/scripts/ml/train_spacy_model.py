...
class SpacyIntentTrainer:
    ...
    def create_model(self):
        ...
        try:
            ...
            # Cargar solo componentes necesarios para textcat
            self.nlp = spacy.load(self.base_model, exclude=[
                "morphologizer", "tagger", "parser",
    ...
    def train(
        ...
        with self.nlp.disable_pipes(*other_pipes):
            ...
            for epoch in range(n_iter):
                ...
                losses = {}
                batches = minibatch(
                    train_examples, size=compounding(4.0, batch_size, 1.001))
    ...
    def _evaluate(self, examples: List[Example]) -> float:
        ...
        for example in examples:
            ...
            correct_label = max(
                example.reference.cats.items(), key=lambda x: x[1])[0]
